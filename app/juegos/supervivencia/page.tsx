...
export default function SupervivenciaPage() {
  ...
  // CAMBIO AQUÍ: ID 2 para Supervivencia
  ...
  return (
    <div className="min-h-screen bg-[#0b121e] text-white p-6 md:p-10">
      <header className="mb-10">
        ...
        <p className="text-gray-400 mt-2 italic text-sm">"Si te gusta sufir intentando sobrevivir en lugares donde absolutamnete todo te mata entre agonías, disfruta."</p>
      </header>
