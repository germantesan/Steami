...
export default function InfantilPage() {
    // --- CONFIGURACIÓN DEL JUEGO TOP (INFANTIL) ---
    const juegoTop = {
        nombre: "Plantas contra Impuestos",
        foto: "/imagenes/pvi.jpg"
    };

    // --- CONFIGURACIÓN DE TUS OTROS JUEGOS INFANTILES ---
    const otrosJuegos = [
        { id: 1, nombre: "Pajaros hambrientos", foto: "/imagenes/pajaros.jpg" },
        { id: 2, nombre: "PEPA LA PIRATA", foto: "/imagenes/infantil-2.jpg" },
        { id: 3, nombre: "POCOYO NO AUTORIZADO", foto: "/imagenes/infantil-3.jpg" },
    ];

    return (
        <div className="p-20 min-h-screen bg-gray-900 text-white text-center">
            <h1 className="text-4xl font-bold text-cyan-400 uppercase tracking-tighter">
                Categoría: Infantil
            </h1>
            ...
            <div className="mt-12 max-w-md mx-auto bg-gradient-to-b from-cyan-900/20 to-gray-800 p-6 rounded-2xl border border-cyan-900/50 shadow-2xl">
            ...
            <h2 className="text-3xl font-bold mt-20 mb-10 text-left border-b border-gray-700 pb-2 uppercase tracking-widest text-cyan-400">
                Diversión (no) apta para todos
            </h2>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                {otrosJuegos.map((juego) => (
                    <div key={juego.id} className="bg-gray-800 p-4 rounded-xl flex flex-col shadow-lg border border-gray-700 hover:border-cyan-900/50 transition">
                ...
                <div className="bg-gray-800/30 h-80 lg:h-auto min-h-[300px] p-6 rounded-xl flex items-center justify-center border-2 border-dashed border-gray-700">
                    <p className="text-gray-600 font-bold italic text-xs uppercase tracking-[0.3em] text-center leading-loose">
                        Más juegos <br/> para niños <br/> próximamente...
                    </p>
                </div>
            </div>
