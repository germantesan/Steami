...
export default function SupervivenciaPage() {
    // --- CONFIGURACIÓN DEL JUEGO TOP (SUPERVIVENCIA) ---
    const juegoTop = {
        ...
        <div className="p-20 min-h-screen bg-gray-900 text-white text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                {otrosJuegos.map((juego) => (
                    <div key={juego.id} className="bg-gray-800 p-4 rounded-xl flex flex-col shadow-lg border border-gray-700 hover:border-lime-900/50 transition">
