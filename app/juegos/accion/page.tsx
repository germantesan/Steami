...
return (
    <div className="p-20 min-h-screen bg-gray-900 text-white text-center">
      {/* Título cambiado a Azul para diferenciar de Terror */}
    <h1 className="text-4xl font-bold text-blue-600 uppercase tracking-tighter">
        Categoría: Acción
    </h1>
    ...
    <div className="mt-12 max-w-md mx-auto bg-gradient-to-b from-blue-900/20 to-gray-800 p-6 rounded-2xl border border-blue-900/50 shadow-2xl">
        <h2 className="text-xl font-bold text-orange-500 mb-2 uppercase">
            TOP VENTAS ACCIÓN
        </h2>

        {/* NOMBRE DEL TOP VENTAS VISIBLE */}
    ...
    <h2 className="text-3xl font-bold mt-20 mb-10 text-left border-b border-gray-700 pb-2 uppercase tracking-widest text-blue-400">
        Otros juegos de Acción
    </h2>

    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {otrosJuegos.map((juego) => (
        <div key={juego.id} className="bg-gray-800 p-4 rounded-xl flex flex-col shadow-lg border border-gray-700 hover:border-blue-900/50 transition">
